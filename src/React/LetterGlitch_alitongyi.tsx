...
const LetterGlitch = ({
  ...
  // Pre-convert hex colors to RGB objects for all glitchColors
  const preConvertedColors = useRef(
    glitchColors.map((hex) => {
      const shorthandRegex = /^#?([a-f\d])([a-f\d])([a-f\d])$/i;
      let resultHex = hex.replace(shorthandRegex, (m, r, g, b) => {
        return r + r + g + g + b + b;
      });
  ...
  const getRandomColor = () => {
    return preConvertedColors[
      Math.floor(Math.random() * preConvertedColors.length)
    ];
  };
